  ...
  return (
    <>
      ...
      <section className="w-full max-w-[800px] mx-auto mt-36 mb-0 text-center px-6">
        <div className="relative overflow-hidden rounded-2xl border border-primary/12 bg-linear-to-b from-primary/6 to-card p-12 md:p-16">
          {/* Subtle radial glow */}
          <div className="pointer-events-none absolute inset-0 flex items-center justify-center">
            <div className="h-[300px] w-[400px] rounded-full bg-primary/6 blur-[80px]" />
          </div>

          <div className="relative">
            <div className="mb-5 inline-flex h-12 w-12 items-center justify-center rounded-xl border border-primary/20 bg-primary/8">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              ...
              <Button
                ...
                variant="outline"
                size="lg"
                className="h-12 px-8 text-[15px] font-semibold rounded-xl hover:-translate-y-0.5 transition-all duration-300"
              >
      ...
      <footer className="mt-24 border-t border-border">
        <div className="max-w-[1200px] mx-auto px-6 py-14">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
            ...
            <div className="col-span-1">
              <Link href="/" className="flex items-center gap-2.5 mb-4">
                <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-primary/8 ring-1 ring-primary/15 text-primary">
          ...
          {/* Bottom bar */}
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 border-t border-border pt-7">
